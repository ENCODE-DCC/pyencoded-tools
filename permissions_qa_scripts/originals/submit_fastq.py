...
THIS NEEDS TO BE FIXED OR UPDATED TO MATCH 

UPLOADS  submit_fastq.py
...
host = 'REPLACEME'
encoded_access_key = 'VMSMRIU7'
encoded_secret_access_key = 's3aj2jwvxznpmxks'

path = 'test.fastq.gz'
my_lab = '/labs/chris-burge/'
my_award = '/awards/R01GM085319/'
assembly = 'hg19'
...
data = {
    ...
    "lab": my_lab,
    "award": my_award,
    "replicate": "3abc1080-0f21-41c6-8926-975fed2516dd",
}
