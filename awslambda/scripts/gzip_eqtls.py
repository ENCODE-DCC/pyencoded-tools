...
out = open('reg_insert_eQTL_files.tsv', 'w')
with open('reg_eQTL_insert_files.txt', 'r') as bed_list:
    ...
    for bed in reader:
        ...
        payload = rocket
        payload['Records'][0]['s3']['object'] = { "key": FOLDER+bed['submitted_file_name']}
        ...
        bed['submitted_file_name'] = 's3://'+BUCKET+'/'+FOLDER+'/'+results['submitted_file_name']
